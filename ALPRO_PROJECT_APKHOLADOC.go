/*
APLIKASI KONSULTASI PASIEN HOLADOC
NAMA: ANDITO RIZKYKA RIANTO | NIM: 1301220016 | KONTRIBUSI: 100%
NAMA: MUHAMMAD HILAL ABYAN  | NIM: 1301223262 | KONTRIBUSI: 100%
*/
package main
...
func replyKonsultasiPasien(patient *dataPasien, konsul *dataKonsul, dokter *dataDokter, topik *dataTopik) {
	...
	*/
	...
	for key {
		...
		fmt.Println("|    Ketik 'post' + enter untuk posting   |")
		fmt.Println("*=========================================*")
